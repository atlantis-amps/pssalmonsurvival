...
#'   \item{\code{GroupType}}{character COLUMN_DESCRIPTION}
#'   \item{\code{IsPredator}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{IsCover}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{IsSiliconDep}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{IsAssessed}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{IsCatchGrazer}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{OverWinters}}{integer COLUMN_DESCRIPTION}
...
#'   \item{\code{isVertebrate}}{integer COLUMN_DESCRIPTION}
#'}
#' @details DETAILS
"functionalgroups"
