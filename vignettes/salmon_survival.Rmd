...
plot_interaction_effect(ensemble.survival, ensemble.cum.survival, scenariocategories, salmonbybasin, salmon.colors)
```
...
plot_predation(ensemblepredationcum, salmoneffect, salmonbybasin, salmon.colors)
