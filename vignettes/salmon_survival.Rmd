...
Plot salmon survival for scenarios, survival is defined as the proportion of age 1 salmon that survive to age 5, the cohort is lagged over time. 
...
plot_ensemble_survival(ensemblenumbersagescenarios, salmongroups, plotmodels)
